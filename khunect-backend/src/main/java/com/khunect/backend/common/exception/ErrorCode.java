...
public enum ErrorCode {
	...
	OAUTH2_EMAIL_NOT_FOUND(HttpStatus.BAD_REQUEST, "AUTH-400-1", "OAuth2 이메일 정보를 찾을 수 없습니다."),
	OAUTH2_EMAIL_DOMAIN_NOT_ALLOWED(HttpStatus.FORBIDDEN, "AUTH-403-1", "경희대학교 이메일만 로그인할 수 있습니다."),
	AUTH_CODE_NOT_FOUND(HttpStatus.NOT_FOUND, "AUTH-404-1", "인증 코드를 찾을 수 없습니다."),
	AUTH_CODE_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH-401-2", "만료된 인증 코드입니다."),
	AUTH_CODE_ALREADY_USED(HttpStatus.CONFLICT, "AUTH-409-1", "이미 사용된 인증 코드입니다."),
	REFRESH_TOKEN_NOT_FOUND(HttpStatus.UNAUTHORIZED, "AUTH-401-3", "유효하지 않은 리프레시 토큰입니다."),
	REFRESH_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "AUTH-401-4", "만료된 리프레시 토큰입니다."),
	REFRESH_TOKEN_REVOKED(HttpStatus.UNAUTHORIZED, "AUTH-401-5", "폐기된 리프레시 토큰입니다."),
	...
	COURSE_CHAT_SIT_TOGETHER_NOT_REQUEST(HttpStatus.BAD_REQUEST, "COURSE-CHAT-400-1", "같이앉기 요청 메시지가 아닙니다."),
	COURSE_CHAT_SIT_TOGETHER_SELF_ACCEPT_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "COURSE-CHAT-400-2", "본인의 같이앉기 요청은 수락할 수 없습니다."),
	COURSE_CHAT_SIT_TOGETHER_ALREADY_ACCEPTED(HttpStatus.CONFLICT, "COURSE-CHAT-409-1", "이미 수락된 같이앉기 요청입니다."),
